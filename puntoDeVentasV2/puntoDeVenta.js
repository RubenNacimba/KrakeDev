calcularValorTotal = function () {
    ...
    if (!esProductoValido(nombreProducto, "lblError1") ||
        ...
        mostrarTexto("lblResumen", "Datos inválidos");
        return;
    }
    ...
    porcentajeDescuento = recuperarInt("lblDescuento");
...
esProductoValido = function(nombreProducto, idError) {
    ...
    if (nombreProducto.trim() === "") {
        ...
        mostrarTexto(idError, "*MÁXIMO 10 CARACTERES");
        hayErrores = true;
    }
...
esCantidadValida = function(cantidad, idError) {
    ...
    if (isNaN(cantidad)) {
        ...
        mostrarTexto(idError, "*VALOR ENTRE 0 Y 100");
        hayErrores = true;
    }
...
esPrecioValido = function(precio, idError) {
    ...
    if (isNaN(precio)) {
        ...
        mostrarTexto(idError, "*VALOR ENTRE 0 Y 50");
        hayErrores = true;
    }
...
limpiar = function () {
    /*
        ...
        Si funciona, hacer un commit
     */
    mostrarTextoEnCaja("txtProducto", "0");
